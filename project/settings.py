...
if environ['DEPLOY'] == "HEROKU":
    import dj_database_url
    DATABASES['default'] =  dj_database_url.config()

FB_APP_ID = environ['FB_APP_ID']
FB_APP_SECRET = environ['FB_APP_SECRET']
FB_NAMESPACE = environ['FB_NAMESPACE']
...
FACEBOOK_API_SECRET = FB_APP_SECRET
